...
WHERE a.last_name='Rowling' AND p.name='Bloomsbury' LIMIT 1;
...
FROM authors a, publishers p
WHERE a.last_name='Orwell' AND p.name='Secker & Warburg' LIMIT 1;

INSERT INTO books (title, subtitle, isbn13, author_id, publisher_id, publication_date, language, page_count, description)
SELECT 'Les Misérables', NULL, '9782070409189',
       a.author_id, p.publisher_id, '1862-01-01', 'fr', 1463,
       'Classic French novel by Victor Hugo.'
FROM authors a, publishers p
WHERE a.last_name='Hugo' AND p.name='Gallimard' LIMIT 1;
...
FROM authors a, publishers p
WHERE a.last_name='Austen' AND p.name='Penguin Books' LIMIT 1;

INSERT INTO books (title, subtitle, isbn13, author_id, publisher_id, publication_date, language, page_count, description)
SELECT 'Adventures of Huckleberry Finn', NULL, '9780486280615',
       a.author_id, p.publisher_id, '1884-12-10', 'en', 366,
       'A classic novel by Mark Twain.'
FROM authors a, publishers p
WHERE a.last_name='Twain' AND p.name='HarperCollins' LIMIT 1;
...
FROM authors a, publishers p
WHERE a.last_name='Christie' AND p.name='HarperCollins' LIMIT 1;
...
FROM authors a, publishers p
WHERE a.last_name='Hemingway' AND p.name='Simon & Schuster' LIMIT 1;
...
FROM authors a, publishers p
WHERE a.last_name='Márquez' AND p.name='HarperCollins' LIMIT 1;

INSERT INTO books (title, subtitle, isbn13, author_id, publisher_id, publication_date, language, page_count, description)
SELECT 'Kafka on the Shore', NULL, '9781400079278',
       a.author_id, p.publisher_id, '2002-09-12', 'jp', 505,
       'Novel by Haruki Murakami.'
FROM authors a, publishers p
WHERE a.last_name='Murakami' AND p.name='Random House' LIMIT 1;
...
FROM authors a, publishers p
WHERE a.last_name='King' AND p.name='Random House' LIMIT 1;
